...
namespace ChihabHajji.XRoad.Sdk.Model
{
    ...
    public partial class TimestampingServiceDiagnostics : IEquatable<TimestampingServiceDiagnostics>, IValidatableObject
    {
        ...
        public TimestampingStatus StatusCode { get; set; }
        /// <summary>
        ...
        public TimestampingServiceDiagnostics(DiagnosticStatusClass statusClass = default(DiagnosticStatusClass), TimestampingStatus statusCode = default(TimestampingStatus))
        {
        ...
        {
            return this.Equals(input as TimestampingServiceDiagnostics);
        }
