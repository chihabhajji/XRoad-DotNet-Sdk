...
namespace ChihabHajji.XRoad.Sdk.Model
{
    ...
    public partial class MemberName : IEquatable<MemberName>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MemberName" /> class.
        /// </summary>
        /// <param name="memberName">memberName.</param>
        public MemberName(string memberName = default(string))
        {
        ...
        {
            return this.Equals(input as MemberName);
        }
        ...
        public bool Equals(MemberName input)
        {
            ...
            return 
                (
                    this._MemberName == input._MemberName ||
                    (this._MemberName != null &&
                    this._MemberName.Equals(input._MemberName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this._MemberName.GetHashCode();
                }
                return hashCode;
            }
        }
